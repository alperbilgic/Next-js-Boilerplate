    ...
    <td align="center" width="33%">
      <a href="https://www.better-auth.com/">
        <picture>
          ...
          <img alt="Better Auth – Modern Authentication for Next.js" src="https://github.com/ixartz/SaaS-Boilerplate/assets/1328388/f80a8bb5-66da-4772-ad36-5fabc5b02c60">
        </picture>
      </a>
    </td>
    <td align="center" width="33%">
...
- 🔒 Authentication with [Better Auth](https://www.better-auth.com/): Sign up, Sign in, Sign out, Forgot password, Reset password, Email verification, and more.
- 👤 Comprehensive Authentication features including Social Auth, Magic Links, Two-Factor Authentication, and more with Better Auth's extensible plugin system
...
The project uses Better Auth for authentication. To get started, you need to configure the required environment variables in your `.env.local` file (not tracked by Git):
...
The `BETTER_AUTH_SECRET` must be at least 32 characters long. For email functionality (verification, password reset), you'll need to configure SMTP settings with your email provider.

Now you have a fully functional authentication system with Next.js, including features such as sign up, sign in, sign out, forgot password, reset password, email verification, and more.
...
You also need to define the environment variables `BETTER_AUTH_SECRET` and your SMTP configuration for email functionality.
...
Go to `Environment variables > Add environment variable`, and define the environment variables `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL`, and your SMTP configuration for email functionality. Click `Save`.
